                            ...
                            <div className="">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    ...
                                    <div className="flex flex-col gap-4 cursor-pointer">
                                        ...
                                        <div className="bg-white rounded-md aspect-video px-1">
                                        <div className="bg-[#E5E7E5]/30 w-full h-full rounded-3xl p-6 md:p-12">
                                            <div>
                                                <div className="font-extrabold font-title uppercase text-3xl md:text-4xl tracking-tighter max-w-xl text-left font-extrabold font-title mb-2">Contactez nous </div>
                                                <div className="py-1 text-gray-500">Votre adresse électronique ne sera pas publiée.</div>
                                                <div className="py-1 text-gray-500 font-extrabold font-title text-sm">Les champs obligatoires sont marqués(*) </div>
