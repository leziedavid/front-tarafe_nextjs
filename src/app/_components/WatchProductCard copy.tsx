                        ...
                        <div className="flex flex-col lg:flex-row">
                            ...
                            <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-4 lg:p-8">
                                ...
                                <div className="relative w-full  mb-4">
                                    {/* Image principale */}
                                    {mainImage ? (
                                        <Image src={mainImageSrc} alt={mainImage.codeId} width={500} height={500} className="max-w-full max-h-full object-contain bg-muted rounded-md "/>
                                    ) : (
                                ...
                                <div className="grid grid-cols-5 gap-4">
                                        {/* Ton composant de pagination occupe les 5 colonnes */}
                                        <div className="col-span-5">
                                            ...
                                            <div className="flex items-center w-full justify-center mb-4 space-x-4">
                                                ...
                                                <div
                                                    className={`w-10 h-10 flex items-center justify-center cursor-pointer rounded-full bg-gray-300 hover:bg-gray-400 transition transform hover:scale-110 ${(currentPage + 1) * imagesPerPage >= image.length ? "opacity-50 cursor-not-allowed" : ""
                                                        }`}
                                                    onClick={nextPage}
                                                >
